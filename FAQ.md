...
The maintained general guide is [upstream FAQ.md](https://github.com/alshedivat/al-folio/blob/main/docs/FAQ.md). Keep this site's custom domain and empty `baseurl` when following upstream examples.
