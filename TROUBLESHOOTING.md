...
The maintained general guide is [upstream TROUBLESHOOTING.md](https://github.com/alshedivat/al-folio/blob/main/docs/TROUBLESHOOTING.md). Keep this site's custom domain and empty `baseurl` when following upstream examples.
